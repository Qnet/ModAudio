...
<script runat="server">
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        'Verify User.
        If pd.isSignedIn() = "No" Then pd.pdRedirect("signin.aspx?refer=chgpsswrd.aspx")
        ...
        If Page.IsPostBack Then
            ...
            'Verify Old Password
            If pd.passwordverified("customer", customerid, oldpassword.Text) = False Then
            ...
            If pd.formerror = "" Then
                ...
                If pd.formerror = "" Then
                    ...
                    pd.LogShopEvent(207, customerid, "")
                    pd.pdRedirect("chgprofile.aspx?showalert=pwchanged")
                End If
...
<div class="form_container">
    <form method="POST" action="chgpsswrd.aspx" id="pageform" name="pageform" runat="server">
    <div class="messages">
        <%=pd.getFormError()%></div>
