...
<script runat="server">
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        If pd.passemail <> "ON" Then pd.pdRedirect("signin.aspx")
        ...
        If Page.IsPostBack Then
            ...
            If pd.formerror = "" Then
                ...
                pd.OpenDataReader("SELECT * FROM customer WHERE email='" & pd.FormatSqlText(email.Text) & "'")
                If pd.ReadDataItem.Read Then

                    emailto = pd.ReadData("email")
                    Name = pd.ReadData("name")
                    custid = pd.ReadDataN("id")
                ...
                If savenewpass = "Yes" Then
                    pd.OpenDataWriter("customer WHERE id=" & custid)
            ...
            If pd.formerror = "" Then
                ...
                pd.LogShopEvent(205, custid, email.Text)
                pd.pdRedirect("signin.aspx?showalert=emailsent")
...
<div class="form_container">
    <form method="POST" action="emailpassword.aspx" id="pageform" name="pageform" runat="server">
    <div class="messages">
        <%=pd.getFormError()%></div>
