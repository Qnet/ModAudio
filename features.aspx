...
<script runat="server">
    ...
    Public catid, catname, catdesc, catpgconfig As String
    Public catitemcount, subcatitemcount, catpagetype As Integer
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        'Indicates to retreive Featured items
        'catid = "F"
        ...
        columnrepeater.DataSource = pd.bindcategoryitems("F", catpagemax)
...
<%= pd.startSection("hdfeatures")%>
<div>
    <div class="messages">
        <%=pd.getFormError()%></div>
    <asp:datalist id="columnrepeater" runat="server" style="width: 99%; table-layout: fixed;" itemstyle-verticalalign="Top">
