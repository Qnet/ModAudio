...
<script runat="server">
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        pd.cssdata.Add(".subcats {display: block;color: ##PDCOLOR1##; font-family: ##PDFONT##; font-size: 12px; font-weight: bold; text-decoration: none;}")
        pd.cssdata.Add(".subcats A {display: block; color: ##PDCOLOR1##; font-family: ##PDFONT##; font-size: 12px; font-weight: bold; text-decoration: none;}")
        pd.cssdata.Add(".subcats A:hover {text-decoration: underline;display: block;margin-left:2em;text-indent:-2em;}")
